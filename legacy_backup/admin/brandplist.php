...
<div class="container">
    ...
    <main class="main">
        ...
        <br>
        <br>
        <h3>List of the premium brands</h3>
        <br>
        <br>
        <br>
        <table>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_row($result)) {
                    ...
                    <tr>
                        ...
                        <td data-cell="Name"><?php echo $row[1] ?></td>
                        <td class="action" data-cell="Action">
                            <a href="./brandPedit.php?id=<?php
                            echo $row[0];
                            ?>">Edit</a>
                            <a class="openModalBtn" data-id="<?php echo $row[0]; ?>"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                    <?php
                }
