    ...
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin-bottom: 70px;">
            <div class="brand-card-perfect">
                <div style="width: 55px; height: 55px; border-radius: 50%; background: rgba(173, 130, 49, 0.15); border: 1px solid var(--brand-gold); display: flex; align-items: center; justify-content: center; color: var(--brand-gold); font-size: 1.3rem; margin-bottom: 20px;">
        ...
        <div style="background: #ffffff; padding: 50px; border-radius: 20px; border: 2px solid var(--brand-gold); box-shadow: var(--shadow-hover); max-width: 850px; margin: 0 auto 80px;">
            ...
            <form action="{{ route('contact.send') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        ...
                        <input type="text" name="name" required placeholder="John Doe" style="width: 100%; padding: 14px 18px; background: #f8fafc; border: 1px solid var(--border-light); border-radius: 10px; color: var(--brand-navy); font-size: 0.95rem;">
                    </div>
                    <div>
                        ...
                        <input type="email" name="email" required placeholder="john@example.com" style="width: 100%; padding: 14px 18px; background: #f8fafc; border: 1px solid var(--border-light); border-radius: 10px; color: var(--brand-navy); font-size: 0.95rem;">
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="subject" required placeholder="Wholesale Inquiry / General Question" style="width: 100%; padding: 14px 18px; background: #f8fafc; border: 1px solid var(--border-light); border-radius: 10px; color: var(--brand-navy); font-size: 0.95rem;">
                </div>
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <textarea name="message" rows="6" required placeholder="Type your message here..." style="width: 100%; padding: 14px 18px; background: #f8fafc; border: 1px solid var(--border-light); border-radius: 10px; color: var(--brand-navy); font-size: 0.95rem;"></textarea>
                </div>

                <div style="text-align: center;">
                    <button type="submit" class="btn-pill-gold" style="width: 100%; justify-content: center;">Send Message <i class="fa-solid fa-paper-plane"></i></button>
                </div>
            </form>
        </div>

        <!-- Google Map Section -->
        <div style="border-radius: 20px; overflow: hidden; border: 2px solid var(--brand-navy); box-shadow: var(--shadow-soft);">
            <iframe
