...
<div class="container">
    ...
    <main class="main">
        ...
        <div class="display-section">
            ...
            $pbrand_count = countRows($conn, 'pbrand_tb');
            $cbrand_count = countRows($conn, 'calidonb_tb');
            $event_count = countRows($conn, 'event_tb');

            ?>
            <div class="row">
                <div class="col">
                    <h2>Premium brands <i class="fa-solid fa-award"></i></h2>
                    <h4><?php echo $pbrand_count; ?></h4>
                    <a href="./brandplist.php">View</a>
                </div>
                <div class="col">
                    <h2>Calidon's brands <i class="fa-solid fa-copyright"></i></h2>
                    <h4><?php echo $cbrand_count; ?></h4>
