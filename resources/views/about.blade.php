    ...
    <div class="container">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-bottom: 80px;">
            <div class="brand-card">
                <div style="width: 52px; height: 52px; border-radius: 12px; background: rgba(173, 130, 49, 0.15); display: flex; align-items: center; justify-content: center; color: var(--brand-gold); font-size: 1.4rem; margin-bottom: 20px; border: 1px solid var(--brand-gold);">
                    <i class="fa-solid fa-timeline"></i>
                </div>
                <h3 class="card-title-navy">Our Journey (Est. 1994)</h3>
            ...
            <div class="brand-card">
                ...
                <h3 class="card-title-navy">Our Vision</h3>
                <p class="card-desc-muted">
            ...
            <div class="brand-card">
                ...
                <h3 class="card-title-navy">Our Products</h3>
                <p class="card-desc-muted">
        ...
        <!-- Core Values Section -->
        <div style="background: var(--brand-navy); color: #fff; padding: 55px; border-radius: 16px; border: 2px solid var(--brand-gold); margin-bottom: 80px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px;">
                <div style="text-align: center; padding: 22px; background: rgba(255,255,255,0.05); border-radius: 12px; border: 1px solid var(--border-gold);">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
                @foreach(['afimage', 'asimage', 'atimage', 'aftimage', 'afthimage', 'asximage', 'asvimage', 'aetimage'] as $imgKey)
                    @if(!empty($gallery->$imgKey))
                        <div style="border-radius: 12px; overflow: hidden; height: 240px; border: 1px solid var(--border-light); box-shadow: var(--shadow-soft);">
