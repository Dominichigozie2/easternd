...
if(isset($_POST['Submit'])){
    ...
    if (move_uploaded_file($tmp_name, $file_path)) {
        ...
        $sql = "INSERT INTO pbrand_tb (pbname, pbdescription, plink, pbimage) VALUES (?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $sql);

        if ($stmt) {
            // Bind parameters to the prepared statement
            mysqli_stmt_bind_param($stmt, 'ssss', $bName, $bDes, $bLink, $image);
            ...
            <main class="main">
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Enter for the Brand Link" name="brandlink">
                    </div>
