...
<?php
        ...
        <div class="container">
            ...
            <main class="main">
                ...
                <br>
                <br>
                <h3>List of the calidon's brands</h3>
                <br>
                <br>
                <br>
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action"
                                data-cell="Action">
                                <a href="./brandcedit.php?id=<?php
                                    echo $row[0];
                                ?>">Edit</a>
                               <a class="CopenModalBtn" data-id="<?php echo $row[0]; ?>"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                        </tr>
                        <?php
                        }
        ...
        <!-- The Modal -->
        <div id="CmyModal" class="Cmodal">
            <!-- Modal content -->
            <div class="Cmodal-content">
                <span class="Cclose">&times;</span>
                <p>Are you sure you want to proceed?</p>
                <a href="#" id="CconfirmBtn">Yes</a>
                <button id="CcancelBtn">No</button>
            </div>
        </div>
